              ...
              <div class="w-full lg:w-8/12">
                ...
                <div class="mt-6">
                  <div class="flex max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md"
                       v-for="(listArticlesItem,listArticlesIndex) in articleData.articles" :key="listArticlesIndex">
                    <div>
                    ...
                    <div class="w-9/12">
                      ...
                      <div class="flex items-center justify-between mt-4">
                        <div class="flex flex-col">
                          <a class="text-blue-500 hover:underline" >Share to
                            facebook</a>
                          <a class="text-blue-500 hover:underline" >Share to
                            twitter</a>
...
export default {
  ...
  async fetch() {
    ...
    this.articleData =await this.$repositories.article.getArticle(this.search); //await this.$axios.get('/home');
